...
export type Identities = Models.Document & {
    userId: string;
    identityType: string;
    label: string;
...
export type Stories = Models.Document & {
    userId: string;
    contentType: ContentType;
...
export type Polls = Models.Document & {
    creatorId: string;
...
export type ArFilters = Models.Document & {
    name: string;
    description: string | null;
...
export type TypingIndicators = Models.Document & {
    conversationId: string;
    userId: string;
    isTyping: boolean;
    expiresAt: string;
...
export type UserStickers = Models.Document & {
    userId: string;
...
export type StoryViews = Models.Document & {
    storyId: string;
    viewerId: string;
...
export type Presence = Models.Document & {
    userId: string;
    status: Status;
    device: string | null;
    lastSeen: string;
...
export type MessageQueue = Models.Document & {
    messageId: string;
    conversationId: string;
    recipientIds: string[];
    pendingFor: string[];
...
export type GiFs = Models.Document & {
    title: string;
    url: string;
    fileId: string | null;
    thumbnailUrl: string | null;
...
export type Follows = Models.Document & {
    followerId: string;
    followingId: string;
    status: Status;
...
export type TokenHoldings = Models.Document & {
    userId: string;
...
export type StickerPacks = Models.Document & {
    name: string;
    description: string | null;
    creatorId: string | null;
...
export type Stickers = Models.Document & {
    name: string;
    description: string | null;
    creatorId: string | null;
    packId: string | null;
